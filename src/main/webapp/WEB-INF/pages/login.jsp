...
.select2-container .select2-choice{background: #E94057 !important;border: 0; color: #fff;padding: 0;text-align: left;}
...
<body>
	<div class="wrapper">
		<div style="background: rgba(0, 0, 0, 0.1); position: absolute; width: 100%; height: 100%;"></div>
